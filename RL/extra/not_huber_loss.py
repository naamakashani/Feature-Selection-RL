...
def save_plot_acuuracy_epoch(accuracy_list):
    ...
    plt.savefig('accuracy_per_validation_epoch_not_huber.png')
    plt.show()
...
def save_plot_reward_epoch(reward_list):
    ...
    plt.ylabel('reward')
    plt.xlabel('epoch')
    plt.savefig('reward_per_epoch_not_huber.png')
    plt.show()
...
def save_plot_step_epoch(steps):
    ...
    plt.ylabel('reward')
    plt.xlabel('epoch')
    plt.savefig('steps_per_epoch_not_huber.png')
    plt.show()
