...
parser.add_argument("--directory",
                    type=str,
                    default="C:\\Users\\kashann\\PycharmProjects\\choiceMira\\RL\\extra",
...
class Guesser(nn.Module):
    ...
    def __init__(self,
        ...
        self.X, self.y, self.question_names, self.features_size = utils.load_sanity()
...
def test(test_loader, path_to_save):
    guesser_filename = 'best_guesser_sanity.pth'
