...
class Guesser(nn.Module):
    ...
    def __init__(self,
        ...
        self.X, self.y, self.question_names, self.features_size = utils.load_dermatology()
        self.X, self.y = balance_class_multi(self.X, self.y)
        ...
        self.optimizer = torch.optim.Adam(self.parameters(),
                                          ...
                                          lr=FLAGS.lr)
        self.path_to_save = os.path.join(os.getcwd(), 'model_guesser_new_data')
